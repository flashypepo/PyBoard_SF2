...
class WS2812:
    ...
    Version: 1.0
    2020-1222 PP updated: changed baudrate
    """
    ...
    def __init__(self, spi_bus=1, led_count=1, intensity=1):
        ...
        * intensity = light intensity (float up to 1)
        ...
        # SPI init
        #2020-1222 PP updated baudrate according to
        # https://forum.micropython.org/viewtopic.php?f=20&t=7166&p=40748&hilit=spi+example#p40748 
        #ORG: self.spi = pyb.SPI(spi_bus, pyb.SPI.MASTER, baudrate=3200000, polarity=0, phase=1)
